...
var opts = {
    "url": ["/", "/download", "/upload", "/jquery.js", "/speed.html", "/jquery.ajax-progress.js", "/ip", "/conf", "/speed.js", "/results", "/modernizr.custom.72111.js", "/geo.js"],
    ...
    req.on('end', function() {
        switch (opts.url.indexOf(url.parse(req.url.replace("//", "/")).pathname)) {
            ...
            case 9:
                ...
                if (opts.mysql.enabled === true && result.uploadSpeed !== null && result.downloadSpeed !== null) {
                    var m = opts.mysql;
                    var db = require("mysql-native").createTCPClient(m.host, m.port);
                    db.auth(m.db, m.user, m.password);
                    db.auto_prepare = true;

                    sql = "INSERT INTO " + m.table +
                    "(ipAddress, locationAccuracy, latitude, longitude, downloadSpeed, uploadSpeed, userAgent, os, device) VALUES ('" +
